...
Public Class FormListarSocio

    Private ligacao As New DBConnect()

    Private Sub FormListagemSocio_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            DataGridView1.Columns.Add("Morada", "Morada")
            ...
            ligacao.PreencherDataGridViewSocios(DataGridView1, "", "", "", "", "", "", "")
    ...
    Private Sub btnPesquisa_Click(sender As Object, e As EventArgs) Handles btnPesquisa.Click
        ...
        If cmbIDSocio.SelectedIndex <> -1 Then
            id = cmbIDSocio.Text.Substring(cmbIDSocio.Text.LastIndexOf(0) + 1)
        End If

        txtNome.Text = Geral.TirarEspacos(txtNome.Text)

        ligacao.PreencherDataGridViewSocios(DataGridView1, id, txtNome.Text, "", "", "", "", "")
